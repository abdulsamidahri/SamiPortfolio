    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 nav-solid-override" style={{ backgroundColor: '#add8e6 !important', borderBottom: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)', background: '#add8e6 !important' }} key="nav-2025">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 text-[17px] ml-[5px] mr-[5px] mt-[5px] mb-[5px] pl-[0px] pr-[0px] pt-[0px] pb-[0px] bg-[#004182] font-extrabold">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <h1 className="lg:text-6xl font-bold text-foreground mb-4 text-center text-[62px]">
